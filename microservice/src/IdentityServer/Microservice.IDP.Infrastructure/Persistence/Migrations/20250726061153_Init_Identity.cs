...
namespace Microservice.IDP.Infrastructure.Persistence.Migrations
{
    /// <inheritdoc />
    public partial class Init_Identity : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "89d52706-783e-4db2-8884-f6bab6968ffb", null, "customer", "CUSTOMER" },
                    { "b5ba75e0-b95b-426e-adb1-f4a5d8474add", null, "administrator", "ADMINISTRATOR" }
                });
